...
public class Factory_OMap_Type_Type_
{
    private String[] names;
    private Type[] values;

    public Factory_OMap_Type_Type_ (CallContext context) {
    }

    static public OMap_Type_Type_ construct (CallContext context) {
        Factory_OMap_Type_Type_ factory = new Factory_OMap_Type_Type_(context);
        factory.set_ParametersAtOnce(context, new String[0], new Type[0]);        
        return factory.create(context);
    }

    public OMap_Type_Type_ create (CallContext context) {
        OMap_Type_Type_ omap = new OMapImpl_Type_Type_(context);
