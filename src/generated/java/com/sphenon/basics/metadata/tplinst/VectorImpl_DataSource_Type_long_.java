...
public class VectorImpl_DataSource_Type_long_
  implements Vector_Type_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Type_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Type_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Type_long_(context, vector_source);
    }

    public Type get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Type) vector_source.get(context).elementAt((int) index);
    ...
    public Type set          (CallContext context, long index, Type item) {
        ...
        return (Type) vector_source.get(context).set((int) index, item);
    }
    ...
    public Type unset        (CallContext context, long index) {
        try {
            return (Type) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
