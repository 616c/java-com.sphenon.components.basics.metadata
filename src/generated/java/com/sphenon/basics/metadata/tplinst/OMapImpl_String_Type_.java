...
public class OMapImpl_String_Type_
  implements OMap_String_Type_
{
    ...
    protected class Entry {
        ...
        private OMapImpl_String_Type_ omap;
        private Type                    index;
        private int                          path_length;
        private Type                    cached_index;

        public Entry (CallContext context, OMapImpl_String_Type_ omap, Type index) {
            this.omap = omap;
            this.index = index;
    ...
    public OMapImpl_String_Type_ (CallContext context)
    {
        map = new java.util.Hashtable ();
    }

    public OMapImpl_String_Type_ (CallContext context, java.util.Hashtable map )
    {
        this.map = map;
    }
    ...
    {
        String item = this.tryGet(context, index);
    ...
    public void     set     (CallContext context, Type index, String item)
    {
        Entry entry = this._getEntry(context, index);
        entry.setItem(context, item);
    }

    public void     add     (CallContext context, Type index, String item) throws AlreadyExists
    {
        Entry entry = this._getEntry(context, index);
    ...
    public void     replace (CallContext context, Type index, String item) throws DoesNotExist
    {
        Entry entry = this._getEntry(context, index);
