...
public class OMapImpl_Object_Type_
  implements OMap_Object_Type_
{
    protected java.util.Hashtable map;

    protected class Entry {
        private Object                     actual_item;
        private Object                     cached_item;
        private java.util.Vector             child_entries;
        private java.util.Vector             parent_entries;
        private OMapImpl_Object_Type_ omap;
        private Type                    index;
        private int                          path_length;
        private Type                    cached_index;

        public Entry (CallContext context, OMapImpl_Object_Type_ omap, Type index) {
            this.omap = omap;
            this.index = index;
        ...
        public void setItem(CallContext context, Object item) {
        ...
        public Object getItem(CallContext context) {
        ...
        public void update (CallContext context) {
            ...
            for (int i=0; i < this.parent_entries.size(); i++) {
                ...
                Object parent_item = parent_entry.getItem(context);
                if (parent_item != null) {
    ...
    public OMapImpl_Object_Type_ (CallContext context)
    {
        map = new java.util.Hashtable ();
    }

    public OMapImpl_Object_Type_ (CallContext context, java.util.Hashtable map )
    {
        this.map = map;
    }
    ...
    public Object get     (CallContext context, Type index) throws DoesNotExist
    {
        Object item = this.tryGet(context, index);
        if (item == null) DoesNotExist.createAndThrow(context);
        return item;
    }

    public Object tryGet  (CallContext context, Type index)
    {
