...
import com.sphenon.basics.many.returncodes.*;
 ...
 public class Pair_Type_Type_ {
    private Type item1;
    private Type item2;

    public Pair_Type_Type_ (CallContext context, Type item1, Type item2) {
        this.item1 = item1;
        this.item2 = item2;
    }
    ...
    public Type getItem2(CallContext context) { return item2; }
    
    public void setItem2(CallContext context, Type item2) { this.item2 = item2; }
}
