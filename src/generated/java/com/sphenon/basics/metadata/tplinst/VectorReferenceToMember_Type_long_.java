...
public class VectorReferenceToMember_Type_long_
    implements ReferenceToMember_Type_long_ReadOnlyVector_Type_long__
{
    private ReadOnlyVector_Type_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Type_long_ (CallContext context, ReadOnlyVector_Type_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public Type get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Type_long_)) return false;
        if (((VectorReferenceToMember_Type_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Type_long_) object).index  != this.index ) return false;
        return true;
    }
