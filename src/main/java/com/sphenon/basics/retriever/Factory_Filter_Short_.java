...
public class Factory_Filter_Short_ {
    ...
    static {
      ...
      config = Configuration.create(context, "com.sphenon.basics.retriever.Factory_Filter_Short_");
    ...
    public Filter_Short_ create (CallContext context) {
        return new FilterByRange_Short_(context);
    }

    static public Filter_Short_ construct (CallContext context, Short minimum, Short maximum) {
        return newInstance(context).create(context, minimum, maximum);
    }

    public Filter_Short_ create (CallContext context, Short minimum, Short maximum) {
        return new FilterByRange_Short_(context, minimum, maximum);
    }
}
