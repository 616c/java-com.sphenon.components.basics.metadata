...
public class MetadataStringPool extends StringPoolClass {
    static protected MetadataStringPool singleton = null;

    static public MetadataStringPool getSingleton (CallContext cc) {
        if (singleton == null) {
            singleton = new MetadataStringPool(cc);
        }
        return singleton;
    }
    ...
    protected MetadataStringPool (CallContext cc) {
        super(cc);
        /*************************************************/
        ...
        addEntry(cc, "0.0.0", "en", "Property 'com.sphenon.basics.metadata.TypeManager.SearchPathes.%(name)' is not defined");
        addEntry(cc, "0.0.0", "de", "Eigenschaft 'com.sphenon.basics.metadata.TypeManager.SearchPathes.%(name)' ist nicht definiert");
        //END-OF-STRINGS
        /*************************************************/
    }
}
