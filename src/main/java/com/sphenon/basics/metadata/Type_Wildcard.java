...
public class Type_Wildcard implements Type
{
    static protected Type_Wildcard singleton;

    static public Type_Wildcard getSingleton (CallContext context) {
        if (singleton == null) {
            singleton = new Type_Wildcard (context);
        }
        return singleton;
    }

    protected Type_Wildcard (CallContext context) {
    }
